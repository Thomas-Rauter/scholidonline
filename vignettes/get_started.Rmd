...
Returned metadata is registry-derived and minimally harmonized
across providers.
...
```{r working with mixed data, eval = FALSE}
x <- c(
...
This separation keeps structural logic (`scholid`) and
registry logic (`scholidonline`) clearly distinct.

## Provider selection

Most functions accept a `provider` argument.

```{r provider argument, eval = FALSE}
scholidonline::id_exists(
  x        = "10.1000/182",
  type     = "doi",
  provider = "crossref"
