...
[`scholid`](https://thomas-rauter.github.io/scholid/) (0.2.0 or later)
...
accessible APIs. Version 0.2.0 supports online operations for:
...
`scholidonline` 0.2.0 requires `scholid` 0.2.0 or later so that new types
can be classified and normalized before online lookup.
