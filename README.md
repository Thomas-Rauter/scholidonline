...
[![R-CMD-check](https://github.com/Thomas-Rauter/scholidonline/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Thomas-Rauter/scholidonline/actions/workflows/R-CMD-check.yaml) [![Codecov test coverage](https://img.shields.io/codecov/c/github/Thomas-Rauter/scholidonline?branch=main&logo=codecov)](https://app.codecov.io/gh/Thomas-Rauter/scholidonline)
...
See the full documentation at the [scholidonline website](https://thomas-rauter.github.io/scholidonline/).
...
The package focuses on online operations for common identifier systems used in scholarly communication:
...
[`scholid`](https://thomas-rauter.github.io/scholid/) provides dependency-free utilities for detecting, normalizing, classifying, and extracting scholarly identifiers.
