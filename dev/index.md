...
| Function                                                                                                                | Purpose                                                        |
|-------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| [`scholidonline_types()`](https://thomas-rauter.github.io/scholidonline/reference/scholidonline_types.md)               | Supported scholidonline identifier types                       |
| [`scholidonline_capabilities()`](https://thomas-rauter.github.io/scholidonline/reference/scholidonline_capabilities.md) | Supported scholidonline capabilities                           |
| [`id_exists()`](https://thomas-rauter.github.io/scholidonline/reference/id_exists.md)                                   | Check whether identifiers exist in their respective registries |
